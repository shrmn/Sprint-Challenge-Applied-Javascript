class TabLink {
  ...
  selectTab(){
    ...
    // Notice we are looping through the this.cards array and invoking selectCard() from 
    // the TabCard class. Just un-comment the code and study what is happening here.
